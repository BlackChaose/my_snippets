...
const showSnippets = cbFunc => {
  const path = 'data/';
  let names = ['js_snippets', 'php_snippets', 'sql_snippets', 'unit_tests', 'laravel', 'linux_commands', 'Bash', 'curl_console', 'git_snippets', 'Angular', 'AngularJS ', 'Handlebars', 'Twig', 'Zen HTML', 'theory'];
